...
import bletch.tektopiarecycler.TektopiaRecycler;
...
public class LoggerUtils {
    ...
    private static final File debugFile = new File(TektopiaRecycler.proxy.getMinecraftDirectory() + ModDetails.FILE_DEBUGLOG);
