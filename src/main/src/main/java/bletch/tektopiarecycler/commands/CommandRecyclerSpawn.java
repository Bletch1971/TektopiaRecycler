...
public class CommandRecyclerSpawn extends CommandRecyclerBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (world == null || world.isRaining() || Village.isNightTime(world)) {
            notifyCommandListener(sender, this, RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".badconditions");
            LoggerUtils.info(TextUtils.translate(RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".badconditions"), true);
            return;
        }
        ...
        if (spawnPosition == null) {
            notifyCommandListener(sender, this, RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".noposition");
            LoggerUtils.info(TextUtils.translate(RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".noposition"), true);
            return;
        }
        ...
        if (recyclerTypeCount > 0) {
            notifyCommandListener(sender, this, RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".exists");
            LoggerUtils.info(TextUtils.translate(RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".exists"), true);
            return;
        }
        ...
        if (!TektopiaUtils.trySpawnEntity(world, spawnPosition, (World w) -> new EntityRecycler(w, recyclerType))) {
            notifyCommandListener(sender, this, RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".failed");
            LoggerUtils.info(TextUtils.translate(RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".failed"), true);
            return;
        }

        notifyCommandListener(sender, this, RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".success", TektopiaUtils.formatBlockPos(spawnPosition));
        LoggerUtils.info(TextUtils.translate(RecyclerCommands.COMMAND_PREFIX + COMMAND_NAME + ".success", TektopiaUtils.formatBlockPos(spawnPosition)), true);
    }
